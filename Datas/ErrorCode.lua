-- Source Excel file path: ['..\\datas\\ErrorCode.xlsx', '..\\datas\\UIGuide.xlsx']
...
return ReadOnly("ErrorCode", {
	...
	[7012] = {
		...
		ContentTC = "裝備中的武器不可出售",
		ErrorCodeContent = "装备中的武器不可出售",
		ErrorCodeId = 7012,
	},
	[7013] = {
		ContentEN = "This item cannot be locked",
		ContentJP = "このアイテムはロックできません",
		ContentKR = "해당 아이템은 잠글 수 없습니다.",
		ContentTC = "該物品無法鎖定",
		ErrorCodeContent = "该物品无法锁定",
		ErrorCodeId = 7013,
	},
	[7014] = {
		ContentEN = "This item cannot be locked or sold",
		ContentJP = "このアイテムはロック/売却できません",
		ContentKR = "해당 아이템은 잠그거나 판매할 수 없습니다.",
		ContentTC = "該物品無法鎖定/出售",
		ErrorCodeContent = "该物品无法锁定/出售",
		ErrorCodeId = 7014,
	},
	[7015] = {
		ContentEN = "This item cannot be sold",
	...
	[10012] = {
		...
		ContentTC = "該該區域不在大世界中",
		ErrorCodeContent = "该该区域不在大世界中",
		ErrorCodeId = 10012,
	},
	[10013] = {
	...
	[20004] = {
		...
		ErrorCodeContent = "无法使用协战伙伴，不存在该角色",
		ErrorCodeId = 20004,
	},
	[21001] = {
	...
	[35001] = {
		ContentEN = "Dynamic event not found",
		ContentJP = "ダイナミックイベントの状態が見つかりません",
		ContentKR = "다이내믹 이벤트 상태가 존재하지 않습니다.",
		ContentTC = "動態事件狀態不存在",
		ErrorCodeContent = "动态事件状态不存在",
		ErrorCodeId = 35001,
	},
	[35002] = {
		ContentEN = "Dynamic event not active",
		ContentJP = "ダイナミックイベントの状態が解放されていません",
		ContentKR = "다이내믹 이벤트 상태가 활성화되지 않았습니다.",
		ContentTC = "動態事件狀態未啟動",
		ErrorCodeContent = "动态事件状态未激活",
		ErrorCodeId = 35002,
	},
	[35003] = {
		ContentEN = "Dynamic event is on cooldown",
		ContentJP = "ダイナミックイベントはクールダウン中です",
		ContentKR = "다이내믹 이벤트가 재사용 대기 상태(CD)입니다.",
		ContentTC = "動態事件處於CD",
	...
	[35005] = {
		ContentEN = "Daily dynamic event attempts used up",
		ContentJP = "毎日のダイナミックイベントの試行回数を使い切りました",
		ContentKR = "오늘의 다이내믹 이벤트 사용 가능 횟수가 모두 소진되었습니다.",
		ContentTC = "當日限次動態事件已達上限",
		ErrorCodeContent = "当日限次动态事件已达上限",
		ErrorCodeId = 35005,
	},
	[35006] = {
		ContentEN = "Maximum completions for this dynamic event reached",
		ContentJP = "このダイナミックイベントの最大完了数に達しました",
		ContentKR = "현재 다이내믹 이벤트 완료 횟수가 상한에 도달했습니다.",
		ContentTC = "當前動態事件完成次數已達上限",
		ErrorCodeContent = "当前动态事件完成次数已达上限",
		ErrorCodeId = 35006,
	},
	[35007] = {
		ContentEN = "Dynamic event check failed",
		ContentJP = "ダイナミックイベント確率チェックエラー",
		ContentKR = "다이내믹 이벤트 확률 판정에 실패했습니다.",
		ContentTC = "動態事件機率判定失敗",
		ErrorCodeContent = "动态事件概率判定失败",
		ErrorCodeId = 35007,
	},
	[35008] = {
		ContentEN = "Incorrect parameters for dynamic event trigger type",
		ContentJP = "ダイナミックイベント発動タイプのパラメータが正しくありません",
		ContentKR = "다이내믹 이벤트 트리거 유형의 파라미터가 올바르지 않습니다.",
		ContentTC = "動態事件觸發類型的參數不正確",
		ErrorCodeContent = "动态事件触发类型的参数不正确",
		ErrorCodeId = 35008,
	},
	[35009] = {
		ContentEN = "Dynamic event in progress",
		ContentJP = "ダイナミックイベントが進行中です",
		ContentKR = "다이내믹 이벤트가 진행 중입니다.",
		ContentTC = "動態事件狀態進行中",
		ErrorCodeContent = "动态事件状态进行中",
		ErrorCodeId = 35009,
	},
	[35010] = {
		ContentEN = "Dynamic event prerequisite not met",
		ContentJP = "ダイナミックイベントの発動条件が満たされていません",
		ContentKR = "다이내믹 이벤트 트리거 조건이 충족되지 않았습니다.",
		ContentTC = "動態事件觸發條件不滿足",
		ErrorCodeContent = "动态事件触发条件不满足",
		ErrorCodeId = 35010,
	},
	[35011] = {
		ContentEN = "Failed to set dynamic event status",
		ContentJP = "ダイナミックイベント状態の設定エラー",
		ContentKR = "다이내믹 이벤트 상태 설정에 실패했습니다.",
