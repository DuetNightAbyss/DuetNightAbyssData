-- Source Excel file path: ..\datas\Achievement.xlsx
local ReadOnly = (DataMgr or {})["ReadOnly"] or function(n, x) return x end
return ReadOnly("AchievementType", {
	[1] = {
		AchievementTypeIcon1 = "/Game/UI/Texture/Dynamic/Atlas/Entrance/T_Entrance_Achievement.T_Entrance_Achievement",
		AchievementTypeIcon2 = "/Game/UI/Texture/Dynamic/Atlas/Entrance/T_Entrance_Achievement_L.T_Entrance_Achievement_L",
		AchievementTypeName = "UI_Achievement_Type_CBT3",
		Id = 1,
	},
	[2] = {
