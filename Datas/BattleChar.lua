...
return ReadOnly("BattleChar", {
	...
	[101] = {
		...
		RoleId = 101,
		Sp = 0,
		UnitBPPath = "/Game/BluePrints/Char/BP_PlayerCharacterSimple.BP_PlayerCharacterSimple_C",
	},
	[102] = {
		ATK = 1500,
		ATKLevelGrow = "ATKA",
	...
	[207] = {
		...
		BattleCharTag = T.RT_2,
		CapsuleInfo = T.RT_21,
		CharAddonAttr = T.RT_25,
		CharGradeDescription = T.RT_26,
		CharGradeParameter = T.RT_27,
	...
	[1101] = {
		...
		MaxHpLevelGrow = "MaxHpA",
		MaxSp = 150,
		ModApplicationType = T.RT_6,
		ModelId = 1101,
		Positioning = "ShortDes_1101",
		RangedWeapon = 20201,
		RecommendAttr = {
			"ATK_Dark",
			"SkillIntensity",
	...
	[1103] = {
		...
		CharGradeParameter = {
			...
			[3] = "$#SkillEffects[110316].TaskEffects[1].Rate*100$%",
			[4] = "$#PassiveEffect[110301].Vars.Grade4ExtraRate*100$%",
			[5] = "$#Buff[110341].AddAttrs[2].Value*100$%",
		},
	...
	[1501] = {
		...
		Attribute = "Light",
		BTMotionParams = T.RT_1,
		BattleCharBuffUI = 1501,
		BattleCharTag = T.RT_18,
		CapsuleInfo = T.RT_19,
		CharName = "UI_CHAR_NAME_4101",
		CondemnWeapon = 30,
		DEF = 300,
	...
	[1503] = {
		...
		CharGradeParameter = {
			...
			[5] = "$#SkillEffects[150325].TaskEffects[2].LastTime$",
	...
	[1801] = {
		...
		ModApplicationType = T.RT_15,
		ModelId = 1801,
		Positioning = "ShortDes_1801",
		RangedWeapon = 20201,
		RecommendAttr = T.RT_23,
		RoleId = 1801,
		SkillList = {
			180101,
			180102,
	...
	[2101] = {
		...
		MaxHpLevelGrow = "MaxHpS",
		MaxSp = 150,
		ModApplicationType = T.RT_37,
		ModelId = 2101,
		Positioning = "ShortDes_2101",
		RangedWeapon = 20201,
		RecommendAttr = {
			"ATK_Water",
			"SkillIntensity",
	...
	[3101] = {
		...
		MaxHpLevelGrow = "MaxHpA",
		MaxSp = 150,
		ModApplicationType = T.RT_39,
		ModelId = 3101,
		Positioning = "ShortDes_3101",
		RangedWeapon = 20201,
		RecommendAttr = {
			"ATK_Fire",
			"SkillIntensity",
	...
	[3201] = {
		...
		ModApplicationType = T.RT_39,
		ModelId = 3201,
		Positioning = "ShortDes_3201",
		RangedWeapon = 20201,
		RecommendAttr = T.RT_41,
		RoleId = 3201,
		SkillList = {
			320101,
			320102,
	...
	[3301] = {
		...
		CharGradeParameter = {
			...
			[3] = "$#PassiveEffect[330101].Vars.TimeAddRate*100$%",
	...
	[4102] = {
		...
		CharGradeParameter = {
			[1] = "$#PassiveEffect[410201].Vars.NoRemoveProbRateEx*100$%",
			[2] = "$#Buff[410214].MaxLayer$",
